    ...
    <Shell>
      <div className="flex flex-col min-h-[calc(100vh-100px)]">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              className={cn("transition-colors", isSidebarOpen ? "bg-primary/10 border-primary/50 text-primary" : "text-muted-foreground")}
        ...
        <div className="flex flex-col lg:flex-row gap-6 flex-1">
          {/* Main Learning Area */}
          <div className="flex-1 flex flex-col min-w-0 bg-card/30 rounded-lg border border-white/5">
            <Tabs defaultValue="theory" className="flex flex-col">
              ...
              <TabsContent value="theory" className="p-6 space-y-6">
                {currentStep === 0 && (
              ...
              <TabsContent value="sim" className="p-6 bg-black/40">
                <LoadSimulator />
              </TabsContent>
          ...
          {/* Steps Sidebar */}
          <div className={cn(
            "w-full lg:w-72 flex-shrink-0 bg-card/20 rounded-lg border border-white/5 p-4 transition-all duration-300 ease-in-out",
